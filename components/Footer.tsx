...
const resourceLinks = [
  { label: "Sermons", href: "https://www.youtube.com/@fotwboston", external: true },
  { label: "Followers of the Way", href: "https://www.youtube.com/@fotwboston", external: true },
  { label: "Podcasts", href: "https://www.youtube.com/@fotwboston", external: true },
  { label: "Blog", href: "https://www.antioch-of-africa.com/blog", external: true },
];

const socialLinks = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/antiochkampala/",
    icon: (
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@antiochChristianResourceCenter",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <a
                  href="mailto:antiochngo@gmail.com"
                  className="text-sm text-muted-foreground hover:text-foreground transition-colors"
                >
                  antiochngo@gmail.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-border">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Antioch Christian Resource Center.
            All rights reserved.
          </p>
        </div>
      </div>
