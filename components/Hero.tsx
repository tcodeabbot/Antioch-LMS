export default function Hero() {
  return (
    <div className="relative w-full -mt-14 sm:-mt-16">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 md:pt-36 pb-10 sm:pb-12 md:pb-16">
